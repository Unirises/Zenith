<div class="d-none" id="p2">
    ...
    <div class="row mt-5">
        ...
        <div class="col-sm-6 text-right">
            <img src="assets/img/resources/efficacy/Outpatient.png" class="cursor_pointer animate__animated animate__fadeInLeft" id="OutpatientBtn" style="width: 50%;" alt="">
        ...
        <div class="col-sm-6">
            <img src="assets/img/resources/efficacy/Chronic_Respiratory.png" class="cursor_pointer animate__animated animate__fadeInRight" id="ChronicBtn" style="width: 50%;" alt="">
    ...
    <div class="row mt-4">
        <div class="col-sm-6 text-right">
            <img src="assets/img/resources/efficacy/Inpatient.png" class="cursor_pointer animate__animated animate__fadeInLeft" id="InpatientBtn" style="width: 50%;" alt="">
        ...
        <div class="col-sm-6">
            <img src="assets/img/resources/efficacy/Asthma.png" id="AsthmaBtn" class="cursor_pointer animate__animated animate__fadeInRight" style="width: 50%;" alt="">
