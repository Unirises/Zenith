<div class="d-none" id="p3">
    ...
    <div class="d-flex flex-column text-right">
        ...
        <div id="p3_trans3"><img src="assets/img/resources/dosage/co-amoxiclav.png" id="co_amoxiclavBtn" class=" cursor_pointer animate__animated animate__fadeInBottomRight" style="height:32vh; width:78%;" alt=""></div>
    </div>
</div>